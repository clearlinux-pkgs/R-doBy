...
Version  : 4.7.0
Release  : 8
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/doBy_4.7.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/doBy_4.7.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751292165
...
/usr/lib64/R/library/doBy/doc/vtools.Rmd
/usr/lib64/R/library/doBy/doc/vtools.html
...
/usr/lib64/R/library/doBy/tests/testthat/test-split_by.R
/usr/lib64/R/library/doBy/tests/testthat/test-vtools.R
